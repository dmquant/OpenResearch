...
const PlanningPhase = () => {
  ...
  const handleApprovePlan = async () => {
    ...
    try {
      ...
      // Add projectId to the research plan for storage context
      const researchPlanWithProjectId = {
        ...state.researchPlan,
        projectId: state.projectId
      }
      
      // Start the actual execution
      await ExecutionEngine.executeResearchPlan(planId, researchPlanWithProjectId, {
        onStart: (execution) => {
